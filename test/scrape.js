...
function stripFluidFieldsOfTag(result) {
...
function stripFluidFieldsOfUnmatched(result) {
    const out = Object.assign({}, result)

    for (var j=0;j<out.requests.length;j++) {
        delete out.requests[j].time
    }

    for (var j=0;j<out.logs.length;j++) {
        delete out.logs[j].timestamp
        delete out.logs[j].networkRequestId
    }
...
describe('Scraper tests', function() {
            ...
            logs: [
                {
                    "source": "javascript",
                    "level": "error",
                    "text": "Access to image at 'http://127.0.0.1:9616/assets/img/star.png' from origin 'http://127.0.0.1:9615' has been blocked by CORS policy: The value of the 'Access-Control-Allow-Origin' header in the response must not be the wildcard '*' when the request's credentials mode is 'include'.",
                    "category": "cors",
                    "url": "http://127.0.0.1:9615/assets/html/unmatched_log_and_request.html"
                },
                {
                    "source": "network",
                    "level": "error",
                    ...
                    "category": "cors",
                    "url": "http://127.0.0.1:9616/assets/img/star.png"
                }
            ],
            requests: [
                {
                    ...
                    "redirectedTo": undefined,
                    "remoteIPAddress": "127.0.0.1",
                    "responseBodyHash": "91dcefd17862614ba861bfc51be075d9b3070af4813528dd48ea46b1a6699ce7",
                    "responseHeaders": {
                        "access-control-allow-origin": "*"
                    },
                    "size": 693,
                ...
                },
                {
                    "failureReason": "net::ERR_FAILED",
                    "initiators": [
                        "http://127.0.0.1:9615/assets/html/unmatched_log_and_request.html"
                    ],
                    "method": "GET",
                    "redirectedFrom": undefined,
                    "redirectedTo": undefined,
    ...
    it('tests if adding and removing script is registered by scraper', async function() {
        // Arrange
        const expectedResult = [
            {
                "element": "SCRIPT",
                ...
                requests: [
                    {
                        ...
                        "responseBodyHash": "b5ce71442f5678d8e54851c832579318c2d139b1582aa7b5bdd6c482f1e26121",
                        "initiators": [
                            "http://127.0.0.1:9615/assets/html/dynamic_script_insert_removal_cross_origin_invalid_integrity_crossorigin.html"
                        ]
                    }
                ],
                logs: [
                    {
                        ...
                        "level": "error",
                        "text": "Failed to find a valid digest in the 'integrity' attribute for resource 'http://127.0.0.1:9616/assets/js/some_script.js' with computed SHA-384 integrity 'OTB95wikPeum8g0co00sBi/YoX8Si1NHyQGdqrOYBGyoKpbqgUntzjW/ACajRLKT'. The resource has been blocked.",
                        "url": "http://127.0.0.1:9615/assets/html/dynamic_script_insert_removal_cross_origin_invalid_integrity_crossorigin.html"
                    }
                ]
            }
        ]
